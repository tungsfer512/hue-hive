 ...
 */
"use strict";
(self["webpackChunkgethue"] = self["webpackChunkgethue"] || []).push([["sparksql-ref"],{

/***/ "./desktop/core/src/desktop/js/sql/reference/sparksql/reservedKeywords.ts":
/*!********************************************************************************!*\
  !*** ./desktop/core/src/desktop/js/sql/reference/sparksql/reservedKeywords.ts ***!
  \********************************************************************************/
...
var RESERVED_WORDS = new Set(['ALL', 'AND', 'AS', 'ASC', 'BIGINT', 'BY', 'CASE', 'COLUMN', 'COLUMNS', 'CROSS', 'DATABASE', 'DESC', 'DIRECTORY', 'DISTINCT', 'EXTENDED', 'FUNCTION', 'ELSE', 'END', 'EXISTS', 'FALSE', 'FROM', 'FULL', 'GROUP', 'HAVING', 'IF', 'IN', 'INTO', 'JOIN', 'LEFT', 'LIKE', 'LIMIT', 'LOCAL', 'NOT', 'NULL', 'ON', 'OPTION', 'OR', 'ORDER', 'OUTER', 'PARTITION', 'REGEXP', 'RIGHT', 'RLIKE', 'ROLE', 'SELECT', 'SEMI', 'TABLE', 'THEN', 'TRUE', 'TRUNCATE', 'UNION', 'WHEN', 'WHERE', 'WITH', 'MAP', 'OVERWRITE', 'QUERY', 'USER']);

/***/ }),

/***/ "./desktop/core/src/desktop/js/sql/reference/sparksql/udfReference.ts":
/*!****************************************************************************!*\
  !*** ./desktop/core/src/desktop/js/sql/reference/sparksql/udfReference.ts ***!
  \****************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "BITWISE_FUNCTIONS": () => (/* binding */ BITWISE_FUNCTIONS),
...
/* harmony export */   "CSV_FUNCTIONS": () => (/* binding */ CSV_FUNCTIONS),
/* harmony export */   "DATE_AND_TIME_FUNCTIONS": () => (/* binding */ DATE_AND_TIME_FUNCTIONS),
/* harmony export */   "GENERATOR_FUNCTIONS": () => (/* binding */ GENERATOR_FUNCTIONS),
/* harmony export */   "JSON_FUNCTIONS": () => (/* binding */ JSON_FUNCTIONS),
/* harmony export */   "MAP_FUNCTIONS": () => (/* binding */ MAP_FUNCTIONS),
/* harmony export */   "MATHEMATICAL_FUNCTIONS": () => (/* binding */ MATHEMATICAL_FUNCTIONS),
/* harmony export */   "MISC_FUNCTIONS": () => (/* binding */ MISC_FUNCTIONS),
...
var AGGREGATE_FUNCTIONS = {
  ...
  approx_count_distinct: {
    ...
    description: 'Returns the estimated cardinality by HyperLogLog++. `relativeSD` defines the maximum estimation error allowed.'
  },
  approx_percentile: {
    ...
    description: 'Returns the approximate percentile value of numeric column `col` at the given percentage. The value of percentage must be between 0.0 and 1.0. The `accuracy` parameter (default: 10000) is a positive numeric literal which controls approximation accuracy at the cost of memory. Higher value of `accuracy` yields better accuracy, `1.0/accuracy` is the relative error of the approximation. When `percentage` is an array, each value of the percentage array must be between 0.0 and 1.0. In this case, returns the approximate percentile array of column `col` at the given percentage array.'
  },
  array_agg: {
    name: 'array_agg',
    returnTypes: ['T'],
  ...
  count_min_sketch: {
    ...
    description: 'Returns a count-min sketch of a column with the given esp, confidence and seed. The result is an array of bytes, which can be deserialized to a `CountMinSketch` before usage. Count-min sketch is a probabilistic data structure used for cardinality estimation using sub-linear space.'
  },
  covar_pop: {
    name: 'covar_pop',
    returnTypes: ['T'],
  ...
  grouping: {
    ...
    draggable: 'grouping()',
    description: 'Indicates whether a specified column in a GROUP BY is aggregated or not, returns 1 for aggregated or 0 for not aggregated in the result set.",'
  },
  grouping_id: {
    name: 'grouping_id',
    returnTypes: ['T'],
  ...
  percentile: {
    ...
    description: 'Returns the exact percentile value of numeric column `col` at the given percentage. The value of percentage must be between 0.0 and 1.0. The value of frequency should be positive integral'
  },
  percentile_approx: {
  ...
  regr_avgx: {
    ...
    draggable: 'regr_avgx()',
    description: 'Returns the average of the independent variable for non-null pairs in a group, where y is the dependent variable and x is the independent variable.'
  },
  regr_avgy: {
    name: 'regr_avgy',
    returnTypes: ['T'],
    ...
    draggable: 'regr_avgy()',
    description: 'Returns the average of the dependent variable for non-null pairs in a group, where y is the dependent variable and x is the independent variable.'
  },
  regr_count: {
    name: 'regr_count',
    returnTypes: ['T'],
    ...
    description: 'Returns the number of non-null number pairs in a group, where y is the dependent variable and x is the independent variable.'
  },
  regr_r2: {
    name: 'regr_r2',
    returnTypes: ['T'],
    ...
    draggable: 'regr_r2()',
    description: 'Returns the coefficient of determination for non-null pairs in a group, where y is the dependent variable and x is the independent variable.'
  },
  skewness: {
    name: 'skewness',
    returnTypes: ['T'],
...
var ARRAY_FUNCTIONS = {
  aggregate: {
    ...
    draggable: 'aggregate()',
    description: 'Applies a binary operator to an initial state and all elements in the array, and reduces this to a single state. The final state is converted into the final result by applying a finish function.'
  },
  array: {
    name: 'array',
    returnTypes: ['T'],
  ...
  array_sort: {
    ...
    description: 'Sorts the input array. If func is omitted, sort in ascending order. The elements of the input array must be orderable. Null elements will be placed at the end of the returned array. Since 3.0.0 this function also sorts and returns the array based on the given comparator function. The comparator will take two arguments representing two elements of the array. It returns -1, 0, or 1 as the first element is less than, equal to, or greater than the second element. If the comparator function returns other values (including null), the function will fail and raise an error.'
  },
  array_union: {
    name: 'array_union',
    returnTypes: ['T'],
  ...
  element_at: {
    ...
    description: 'Returns element of array at given (1-based) index. If index < 0, accesses elements from the last to the first. Returns NULL if the index exceeds the length of the array.'
  },
  filter: {
    name: 'filter',
    returnTypes: ['T'],
  ...
  try_element_at: {
    ...
    description: 'Returns element of array at given (1-based) index. If Index is 0, Spark will throw an error. If index < 0, accesses elements from the last to the first. The function always returns NULL if the index exceeds the length of the array.\n\nFor maps it returns value for given key. The function always returns NULL if the key is not contained in the map.'
  },
  zip_with: {
    name: 'zip_with',
    returnTypes: ['T'],
...
var DATE_AND_TIME_FUNCTIONS = {
  ...
  to_timestamp: {
    ...
    description: 'Parses the `timestamp_str` expression with the `fmt` expression to a timestamp. Returns null with invalid input. By default, it follows casting rules to a timestamp if the `fmt` is omitted.'
  },
  to_unix_timestamp: {
...
var JSON_FUNCTIONS = {
  ...
  json_tuple: {
    ...
    description: 'Returns a tuple like the function get_json_object, but it takes multiple names. All the input parameters and output column types are string.'
  },
  schema_of_json: {
    name: 'schema_of_json',
    returnTypes: ['T'],
...
var MAP_FUNCTIONS = {
  ...
  str_to_map: {
    ...
    description: "Creates a map after splitting the text into key/value pairs using delimiters. Default delimiters are ',' for pairDelim and ':' for keyValueDelim. Both pairDelim and keyValueDelim are treated as regular expressions."
  },
  transform_keys: {
    name: 'transform_keys',
    returnTypes: ['T'],
...
var MATHEMATICAL_FUNCTIONS = {
  ...
  acos: {
    ...
    signature: 'acos(expr)',
    draggable: 'acos()',
    description: 'Returns the inverse cosine (a.k.a. arc cosine) of expr, as if computed by java.lang.Math.acos.'
  },
  acosh: {
    name: 'acosh',
    returnTypes: ['T'],
  ...
  asin: {
    ...
    signature: 'asin(expr)',
    draggable: 'asin()',
    description: 'Returns the inverse sine (a.k.a. arc sine) the arc sin of expr, as if computed by java.lang.Math.asin.'
  },
  asinh: {
    name: 'asinh',
    returnTypes: ['T'],
  ...
  atan: {
    ...
    signature: 'atan(expr)',
    draggable: 'atan()',
    description: 'Returns the inverse tangent (a.k.a. arc tangent) of expr, as if computed by java.lang.Math.atan.'
  },
  atan2: {
    name: 'atan2',
    returnTypes: ['T'],
    ...
    draggable: 'atan2()',
    description: 'Returns the angle in radians between the positive x-axis of a plane and the point given by the coordinates (exprX, exprY), as if computed by java.lang.Math.atan2.'
  },
  atanh: {
    name: 'atanh',
    returnTypes: ['T'],
  ...
  div: {
    ...
    draggable: 'div()',
    description: 'Divide `expr1` by `expr2`. It returns NULL if an operand is NULL or `expr2` is 0. The result is casted to long.'
  },
  degrees: {
    name: 'degrees',
    returnTypes: ['T'],
  ...
  rand: {
    ...
    signature: 'rand([seed])',
    draggable: 'rand()',
    description: 'Returns a random value with independent and identically distributed (i.i.d.) uniformly distributed values in [0, 1).'
  },
  randn: {
    name: 'randn',
    returnTypes: ['T'],
    ...
    draggable: 'randn()',
    description: 'Returns a random value with independent and identically distributed (i.i.d.) values drawn from the standard normal distribution.'
  },
  random: {
    name: 'random',
    returnTypes: ['T'],
  ...
  try_add: {
    ...
    draggable: 'try_add()',
    description: 'Returns the sum of expr1and expr2 and the result is null on overflow. The acceptable input types are the same with the + operator.'
  },
  try_divide: {
    name: 'try_divide',
    returnTypes: ['T'],
    ...
    description: 'Returns dividend/divisor. It always performs floating point division. Its result is always null if expr2 is 0. dividend must be a numeric or an interval. divisor must be a numeric.'
  },
  try_multiply: {
    name: 'try_multiply',
    returnTypes: ['T'],
    ...
    description: 'Returns expr1*expr2 and the result is null on overflow. The acceptable input types are the same with the * operator.'
  },
  try_subtract: {
    name: 'try_subtract',
    returnTypes: ['T'],
  ...
  width_bucket: {
    ...
    description: 'Returns the bucket number to which value would be assigned in an equiwidth histogram with num_bucket buckets, in the range min_value to max_value."'
  }
};
var MISC_FUNCTIONS = {
  aes_decrypt: {
  ...
  aes_encrypt: {
    ...
    description: "Returns an encrypted value of expr using AES in given mode with the specified padding. Key lengths of 16, 24 and 32 bits are supported. Supported combinations of (mode, padding) are ('ECB', 'PKCS') and ('GCM', 'NONE'). The default mode is GCM.\n" + '\n' + 'Arguments:\n' + '\n' + 'expr - The binary value to encrypt.\n' + 'key - The passphrase to use to encrypt the data.\n' + 'mode - Specifies which block cipher mode should be used to encrypt messages. Valid modes: ECB, GCM.\n' + 'padding - Specifies how to pad messages whose length is not a multiple of the block size. Valid values: PKCS, NONE, DEFAULT. The DEFAULT padding means PKCS for ECB and NONE for GCM.'
  },
  assert_true: {
    name: 'assert_true',
    returnTypes: ['T'],
  ...
  cardinality: {
    ...
    description: 'Returns the size of an array or a map. The function returns null for null input if spark.sql.legacy.sizeOfNull is set to false or spark.sql.ansi.enabled is set to true. Otherwise, the function returns -1 for null input. With the default settings, the function returns -1 for null input.'
  },
  crc32: {
    name: 'crc32',
    returnTypes: ['T'],
  ...
  cube: {
    ...
    draggable: 'cube()',
    description: 'Create a multi-dimensional cube using the specified columns so that we can run aggregation on them.'
  },
  current_catalog: {
  ...
  find_in_set: {
    ...
    description: 'Returns the index (1-based) of the given string (str) in the comma-delimited list (str_array). Returns 0, if the string was not found or if the given string (str) contains a comma.'
  },
  forall: {
    name: 'forall',
    returnTypes: ['T'],
  ...
  rollup: {
    ...
    draggable: 'rollup()',
    description: 'Create a multi-dimensional rollup using the specified columns so that we can run aggregation on them.'
  },
  sha: {
    name: 'sha',
    returnTypes: ['T'],
  ...
  version: {
    ...
    signature: 'version()',
    draggable: 'version()',
    description: 'Returns the Spark version. The string contains 2 fields, the first being a release version and the second being a git revision.'
  },
  xpath: {
    name: 'xpath',
    returnTypes: ['T'],
  ...
  xpath_double: {
    ...
    description: 'Returns a double value, the value zero if no match is found, or NaN if a match is found but the value is non-numeric.'
  },
  xpath_float: {
    name: 'xpath_float',
    returnTypes: ['T'],
    ...
    description: 'Returns a float value, the value zero if no match is found, or NaN if a match is found but the value is non-numeric.'
  },
  xpath_int: {
    name: 'xpath_int',
    returnTypes: ['T'],
    ...
    draggable: 'xpath_int()',
    description: 'Returns an integer value, or the value zero if no match is found, or a match is found but the value is non-numeric.'
  },
  xpath_long: {
    name: 'xpath_long',
    returnTypes: ['T'],
    ...
    description: 'Returns a long integer value, or the value zero if no match is found, or a match is found but the value is non-numeric.'
  },
  xpath_number: {
    name: 'xpath_number',
    returnTypes: ['T'],
  ...
  xpath_short: {
    ...
    description: 'Returns a short integer value, or the value zero if no match is found, or a match is found but the value is non-numeric.'
  },
  xpath_string: {
    name: 'xpath_string',
    returnTypes: ['T'],
...
var PREDICATE_FUNCTIONS = {
  ilike: {
    ...
    draggable: 'ilike()',
    description: 'Returns true if str matches pattern with case-insensitively, null if any arguments are null, false otherwise.'
  },
  isnan: {
    name: 'isnan',
    returnTypes: ['BOOLEAN'],
...
var STRING_FUNCTIONS = {
  ...
  "char": {
    ...
    signature: 'char(expr)',
    draggable: 'char()',
    description: 'Returns the ASCII character having the binary equivalent to expr. If n is larger than 256 the result is equivalent to chr(n % 256)'
  },
  char_length: {
    name: 'char_length',
    returnTypes: ['T'],
  ...
  contains: {
    ...
    draggable: 'contains()',
    description: 'Returns a boolean. The value is True if right is found inside left. Returns NULL if either input expression is NULL. Otherwise, returns False. Both left or right must be of STRING or BINARY type.'
  },
  decode: {
    name: 'decode',
    returnTypes: ['T'],
    ...
    signature: 'decode(bin, charset), decode(expr, search, result [, search, result ] ... [, default])',
    draggable: 'decode()',
  ...
  endswith: {
    ...
    draggable: 'endswith()',
    description: 'Returns a boolean. The value is True if left ends with right. Returns NULL if either input expression is NULL. Otherwise, returns False. Both left or right must be of STRING or BINARY type.'
  },
  format_number: {
    name: 'format_number',
    returnTypes: ['T'],
    ...
    description: "Formats the number expr1 like '#,###,###.##', rounded to expr2 decimal places. If expr2 is 0, the result has no decimal point or fractional part. expr2 also accept a user specified format. This is supposed to function like MySQL's FORMAT."
  },
  format_string: {
    name: 'format_string',
    returnTypes: ['T'],
  ...
  initcap: {
    ...
    draggable: 'initcap()',
    description: 'Returns str with the first letter of each word in uppercase. All other letters are in lowercase. Words are delimited by white space.'
  },
  instr: {
    name: 'instr',
    returnTypes: ['T'],
  ...
  left: {
    ...
    draggable: 'left()',
    description: 'Returns the leftmost len(len can be string type) characters from the string str,if len is less or equal than 0 the result is an empty string.'
  },
  length: {
    name: 'length',
    returnTypes: ['T'],
  ...
  lpad: {
    ...
    draggable: 'lpad()',
    description: 'Returns str, left-padded with pad to a length of len. If str is longer than len, the return value is shortened to len characters. If pad is not specified, str will be padded to the left with space characters.'
  },
  ltrim: {
    name: 'ltrim',
    returnTypes: ['T'],
  ...
  regexp_extract_all: {
    ...
    description: 'Extract all strings in the str that match the regexp expression and corresponding to the regex group index.'
  },
  repeat: {
    name: 'repeat',
    returnTypes: ['T'],
  ...
  right: {
    ...
    draggable: 'right()',
    description: 'Returns the rightmost len(len can be string type) characters from the string str,if len is less or equal than 0 the result is an empty string.'
  },
  rpad: {
    name: 'rpad',
    returnTypes: ['T'],
    ...
    draggable: 'rpad()',
    description: 'Returns str, right-padded with pad to a length of len. If str is longer than len, the return value is shortened to len characters. If pad is not specified, str will be padded to the right with space characters.'
  },
  rtrim: {
    name: 'rtrim',
    returnTypes: ['T'],
  ...
  startswith: {
    ...
    description: 'Returns a boolean. The value is True if left starts with right. Returns NULL if either input expression is NULL. Otherwise, returns False. Both left or right must be of STRING or BINARY type.'
  },
  substr: {
    name: 'substr',
    returnTypes: ['T'],
  ...
  substring_index: {
    ...
    description: 'Returns the substring from str before count occurrences of the delimiter delim. If count is positive, everything to the left of the final delimiter (counting from the left) is returned. If count is negative, everything to the right of the final delimiter (counting from the right) is returned. The function substring_index performs a case-sensitive match when searching for delim.'
  },
  to_binary: {
    name: 'to_binary',
    returnTypes: ['T'],
    ...
    draggable: 'to_binary()',
    description: 'Converts the input str to a binary value based on the supplied fmt. fmt can be a case-insensitive string literal of "hex", "utf-8", or "base64". By default, the binary format for conversion is "hex" if fmt is omitted. The function returns NULL if at least one of the input parameters is NULL.'
  },
  to_number: {
    name: 'to_number',
    returnTypes: ['T'],
  ...
  translate: {
    ...
    draggable: 'translate()',
    description: 'Translates the input string by replacing the characters present in the from string with the corresponding characters in the to string.'
  },
  trim: {
    name: 'trim',
    returnTypes: ['T'],
  ...
  try_to_binary: {
    ...
    description: 'This is a special version of to_binary that performs the same operation, but returns a NULL value instead of raising an error if the conversion cannot be performed.'
  },
  try_to_number: {
    name: 'try_to_number',
    returnTypes: ['T'],
    ...
    description: "Convert string 'expr' to a number based on the string format fmt. Returns NULL if the string 'expr' does not match the expected format. The format follows the same semantics as the to_number function."
  },
  ucase: {
    name: 'ucase',
    returnTypes: ['T'],
...
var WINDOW_FUNCTIONS = {
  ...
  lag: {
    ...
    draggable: 'lag()',
    description: 'Returns the value of `input` at the `offset`th row before the current row in the window. The default value of `offset` is 1 and the default value of `default` is null. If the value of `input` at the `offset`th row is null, null is returned. If there is no such offset row (e.g., when the offset is 1, the first row of the window does not have any previous row), `default` is returned.'
  },
  lead: {
    name: 'lead',
    returnTypes: ['T'],
    ...
    draggable: 'lead()',
    description: 'Returns the value of `input` at the `offset`th row after the current row in the window. The default value of `offset` is 1 and the default value of `default` is null. If the value of `input` at the `offset`th row is null, null is returned. If there is no such an offset row (e.g., when the offset is 1, the last row of the window does not have any subsequent row), `default` is returned.'
  },
  ntile: {
    name: 'ntile',
    returnTypes: ['T'],
...
var UDF_CATEGORIES = [{
  ...
  name: (0,_utils_i18n__WEBPACK_IMPORTED_MODULE_0__["default"])('Array'),
  functions: ARRAY_FUNCTIONS
}, {
  name: (0,_utils_i18n__WEBPACK_IMPORTED_MODULE_0__["default"])('Bitwise'),
  functions: BITWISE_FUNCTIONS
}, {
  name: (0,_utils_i18n__WEBPACK_IMPORTED_MODULE_0__["default"])('Conditional'),
  functions: CONDITIONAL_FUNCTIONS
}, {
  name: (0,_utils_i18n__WEBPACK_IMPORTED_MODULE_0__["default"])('Conversion'),
  functions: CONVERSION_FUNCTIONS
}, {
  name: (0,_utils_i18n__WEBPACK_IMPORTED_MODULE_0__["default"])('CSV'),
  functions: CSV_FUNCTIONS
}, {
  name: (0,_utils_i18n__WEBPACK_IMPORTED_MODULE_0__["default"])('Date and Time'),
  functions: DATE_AND_TIME_FUNCTIONS
}, {
  name: (0,_utils_i18n__WEBPACK_IMPORTED_MODULE_0__["default"])('Generator'),
  functions: GENERATOR_FUNCTIONS
}, {
  name: (0,_utils_i18n__WEBPACK_IMPORTED_MODULE_0__["default"])('JSON'),
  functions: JSON_FUNCTIONS
}, {
  name: (0,_utils_i18n__WEBPACK_IMPORTED_MODULE_0__["default"])('Map'),
  ...
  name: (0,_utils_i18n__WEBPACK_IMPORTED_MODULE_0__["default"])('Predicate'),
  functions: PREDICATE_FUNCTIONS
}, {
  name: (0,_utils_i18n__WEBPACK_IMPORTED_MODULE_0__["default"])('String'),
  functions: STRING_FUNCTIONS
}, {
  name: (0,_utils_i18n__WEBPACK_IMPORTED_MODULE_0__["default"])('Window'),
  isAnalytic: true,
...
//# sourceMappingURL=/static/desktop/js/bundles/hue/sparksql-ref-chunk-a2a4f8506cb55bb7.js.map
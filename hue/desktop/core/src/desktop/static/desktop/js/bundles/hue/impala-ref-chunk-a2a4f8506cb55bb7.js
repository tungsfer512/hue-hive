...
var CONDITIONAL_FUNCTIONS = {
  ...
  nvl2: {
    ...
    draggable: 'nvl2()',
    description: 'Returns the second argument, ifNotNull, if the first argument is not NULL. Returns the third argument, ifNull, if the first argument is NULL.'
  },
  zeroifnull: {
    name: 'zeroifnull',
    returnTypes: ['T'],
...
//# sourceMappingURL=/static/desktop/js/bundles/hue/impala-ref-chunk-a2a4f8506cb55bb7.js.map